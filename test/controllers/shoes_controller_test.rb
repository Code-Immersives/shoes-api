...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { brand: @shoe.brand, color: @shoe.color, imgURL: @shoe.imgURL, size: @shoe.size } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { brand: @shoe.brand, color: @shoe.color, imgURL: @shoe.imgURL, size: @shoe.size } }
